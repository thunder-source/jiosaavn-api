...
import { NewReleasesAPIResponseModel, type NewReleasesAPIResponseModelApi } from '../models'
...
describe('newReleasesController', () => {
  ...
  it('new data 123', async () => {
    const response = await newReleasesController.controller.request('/newReleases?p=0&n=10&languages=hindi')
